...
class _PasswordChangeWidgetState extends State<PasswordChangeWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'PasswordChange'});
            ...
            children: [
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'PASSWORD_CHANGE_PAGE_Row_wfoodq2n_ON_TAP');
                  ...
                  child: Row(
                    ...
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          logFirebaseEvent(
                              'PASSWORD_CHANGE_arrow_back_ICN_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'doxoa6uf' /* Create your new password. If y... */,
                              ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'PASSWORD_CHANGE_PAGE_CONFIRM_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');

                        context.pushNamed(
                          PasswordCreationSuccessfulWidget.routeName,
