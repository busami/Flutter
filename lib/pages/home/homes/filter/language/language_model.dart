...
class LanguageModel extends FlutterFlowModel<LanguageWidget> {
  ...
  // Model for FilterOptionCard component.
  late FilterOptionCardModel filterOptionCardModel6;
  // Model for FilterOptionCard component.
  late FilterOptionCardModel filterOptionCardModel7;
  ...
  void initState(BuildContext context) {
    ...
    filterOptionCardModel5 =
        createModel(context, () => FilterOptionCardModel());
    filterOptionCardModel6 =
        createModel(context, () => FilterOptionCardModel());
    filterOptionCardModel7 =
        createModel(context, () => FilterOptionCardModel());
  }
  ...
  void dispose() {
    ...
    filterOptionCardModel6.dispose();
    filterOptionCardModel7.dispose();
  }
}
