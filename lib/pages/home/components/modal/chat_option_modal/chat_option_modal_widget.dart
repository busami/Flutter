...
import 'chat_option_modal_model.dart';
export 'chat_option_modal_model.dart';

class ChatOptionModalWidget extends StatefulWidget {
  const ChatOptionModalWidget({
    super.key,
  ...
  @override
  State<ChatOptionModalWidget> createState() => _ChatOptionModalWidgetState();
}

class _ChatOptionModalWidgetState extends State<ChatOptionModalWidget>
    with TickerProviderStateMixin {
  late ChatOptionModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatOptionModalModel());
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'CHAT_OPTION_MODAL_Container_wypk2f63_ON_');
                          logFirebaseEvent(
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'CHAT_OPTION_MODAL_Container_egh6qpt2_ON_');
                          logFirebaseEvent(
                              'OptionCard_02_close_dialog_drawer_etc');
                          Navigator.pop(context);
                        },
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'CHAT_OPTION_MODAL_Container_66f5yiu5_ON_');
                          logFirebaseEvent(
                              'OptionCard_02_close_dialog_drawer_etc');
                          Navigator.pop(context);
                        },
                ...
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('CHAT_OPTION_MODAL_COMP_x_ICN_ON_TAP');
