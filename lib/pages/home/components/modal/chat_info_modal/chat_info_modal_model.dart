...
import 'chat_info_modal_widget.dart' show ChatInfoModalWidget;
import 'package:flutter/material.dart';

class ChatInfoModalModel extends FlutterFlowModel<ChatInfoModalWidget> {
  ...
  // Model for OptionCard_02 component.
  late OptionCard02Model optionCard02Model6;
  // Model for OptionCard_02 component.
  late OptionCard02Model optionCard02Model7;
  ...
  void initState(BuildContext context) {
    ...
    optionCard02Model6 = createModel(context, () => OptionCard02Model());
    optionCard02Model7 = createModel(context, () => OptionCard02Model());
  }
  ...
  void dispose() {
    ...
    optionCard02Model6.dispose();
    optionCard02Model7.dispose();
  }
}
