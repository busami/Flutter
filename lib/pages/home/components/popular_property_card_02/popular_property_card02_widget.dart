...
import 'popular_property_card02_model.dart';
export 'popular_property_card02_model.dart';

class PopularPropertyCard02Widget extends StatefulWidget {
  const PopularPropertyCard02Widget({
    super.key,
    required this.title,
    required this.price,
  ...
  @override
  State<PopularPropertyCard02Widget> createState() =>
      _PopularPropertyCard02WidgetState();
}

class _PopularPropertyCard02WidgetState
    extends State<PopularPropertyCard02Widget> {
  late PopularPropertyCard02Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopularPropertyCard02Model());
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(6.0, 10.0, 6.0, 6.0),
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
