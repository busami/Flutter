...
import 'properties_card_model.dart';
export 'properties_card_model.dart';
...
class _PropertiesCardWidgetState extends State<PropertiesCardWidget> {
  late PropertiesCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertiesCardModel());
                  ...
                  children: [
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PROPERTIES_CARD_EDIT_LISTING_BTN_ON_TAP');
                          logFirebaseEvent('Button_navigate_to');

                          context.pushNamed(EditListingWidget.routeName);
                        },
                        text: FFLocalizations.of(context).getText(
                          'mrzr20je' /* Edit Listing */,
                        ),
                    ...
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PROPERTIES_CARD_VIEW_PROPERTY_BTN_ON_TAP');
                          logFirebaseEvent('Button_navigate_to');
