        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('LISTING_DETAILS_arrow_back_ICN_ON_TAP');
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'gho3bjv1' /* Golden Gleam Property */,
                ),
                style: FlutterFlowTheme.of(context).bodyMedium.override(
                      font: GoogleFonts.cairo(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'LISTING_DETAILS_PAGE_Row_l32pf8nt_ON_TAP');
                                            logFirebaseEvent('Row_navigate_to');

                                            context.pushNamed(
                                                DeveloperPriceHistoryWidget
                                                    .routeName);
                                          },
                                          child: Row(
                                            mainAxisSize: MainAxisSize.max,
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'qzukurqu' /* Avarage price by March 2025 */,
                                              ),
                                              style:
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'm8z9yvm9' /* vs conntracted price (USD 86,5... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                        ...
                                        Expanded(
                                          child: Container(
                                            ...
                                            height: 100.0,
                                            decoration: BoxDecoration(
                                              color: Color(0x1B567FED),
                                              borderRadius:
                                                  BorderRadius.circular(6.0),
                                            ),
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(8.0, 5.0, 8.0, 6.0),
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'g6eh0cxi' /* This price to subjet to change... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'jpm6ddxt' /* Listing your property has neve... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
