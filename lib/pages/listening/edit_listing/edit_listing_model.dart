...
class EditListingModel extends FlutterFlowModel<EditListingWidget> {
  ...
  bool isDataUploading_uploadDataO5s1 = false;
  FFUploadedFile uploadedLocalFile_uploadDataO5s1 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadDataO5s2 = false;
  FFUploadedFile uploadedLocalFile_uploadDataO5s2 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadDataO5s3 = false;
  FFUploadedFile uploadedLocalFile_uploadDataO5s3 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadDataO5s4 = false;
  FFUploadedFile uploadedLocalFile_uploadDataO5s4 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadDataO5s5 = false;
  FFUploadedFile uploadedLocalFile_uploadDataO5s5 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadDataO5s6 = false;
  FFUploadedFile uploadedLocalFile_uploadDataO5s6 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
